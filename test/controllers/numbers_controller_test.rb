...
class NumbersControllerTest < ActionController::TestCase
  ...
  test "should create number" do
    assert_difference('Number.count') do
      post :create, number: { numberset_id: @number.numberset_id, position: @number.position, text: @number.text }
    end
  ...
  test "should update number" do
    patch :update, id: @number, number: { numberset_id: @number.numberset_id, position: @number.position, text: @number.text }
    assert_redirected_to number_path(assigns(:number))
  end
